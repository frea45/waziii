...
async def VidWatermarkAdder(bot, cmd):
	...
	if (int(file_size) > 25٬050٬010) and (Config.ALLOW_UPLOAD_TO_STREAMTAPE is True) and (Config.STREAMTAPE_API_USERNAME != "NoNeed") and (Config.STREAMTAPE_API_PASS != "NoNeed"):
